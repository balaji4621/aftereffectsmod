// Adobe After Effects 2025 - Exact YouTube Short Audio Pipeline
(function () {
    try {
        app.beginUndoGroup("Exact YouTube Short Audio Edit");
        ...
        for (var i = 0; i < clipFiles.length; i++) {
            ...
            if (file.exists) {
                ...
                // Mute original video audio so ONLY the YouTube Short song plays
                ...
                // Pitch-Adaptive Beat Shake & Zoom Expressions
        ...
        // Save AE Project (.aep)
        var aepPath = new File("C:/Users/ADMIN/OneDrive/Desktop/ae/antigravity_yt_song.aep");
        proj.save(aepPath);
