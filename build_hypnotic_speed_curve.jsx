// Adobe After Effects 2025 - Master Hypnotic Speed Curve & Adaptive Beat Sync Engine
(function () {
    try {
        app.beginUndoGroup("Hypnotic Speed Curve Masterpiece");
        ...
        if (!videoFile.exists) {
            var logErr = new File("C:/Users/ADMIN/OneDrive/Desktop/ae/ae_error_log.txt");
            logErr.open("w");
            logErr.write("Video file missing");
            logErr.close();
            return;
        }
        ...
        // 4. Pitch-Adaptive Camera Shake & Hypnotic Zoom Punch Expressions
        ...
        // Save AE Project (.aep)
        var aepPath = new File("C:/Users/ADMIN/OneDrive/Desktop/ae/hypnotic_speed_curve_master.aep");
        proj.save(aepPath);

        app.endUndoGroup();

        var logSuccess = new File("C:/Users/ADMIN/OneDrive/Desktop/ae/ae_error_log.txt");
        logSuccess.open("w");
        logSuccess.write("SUCCESS");
        logSuccess.close();
    } catch (mainErr) {
        var logFile = new File("C:/Users/ADMIN/OneDrive/Desktop/ae/ae_error_log.txt");
        logFile.open("w");
        logFile.write("ERROR: " + mainErr.toString() + " at line " + mainErr.line);
        logFile.close();
    }
})();
